        ...
        if ($config['cron'] == 1){
            ...
            if ($new2 === FALSE) {
                ...
                if ($new === FALSE) {
                    ...
                    if($log == 1)  fwrite($fh, mydate().": (WG) Successful get some data from WG."."\n");
                }
                if (empty($new2)){
                    $new2['status'] = 'error';
                }
                ...
                if ($new2['status'] == 'ok'){
                            ...
                            if (!empty($toload)) {
                                ...
                                foreach ($res1 as $key => $val) {
                                   if ($val['status'] == 'ok' ) {
                                       ...
                                       if($log == 1){ fwrite($fh, mydate().": (Info) Writing player ".sprintf("%03d", $plc).": ".$val['data']['nickname']."\n"); }
                                       ...
                                       fwrite($fh, mydate().": (Err) Not correct data for player ".sprintf("%03d", $plc)." with ID : ".$val['data']['account_id'].$message."\n"); }
                                   }
                                   $plc++;
                                }
                    ...
                    if($log == 1) fwrite($fh, mydate().": (Err) Unusual roster from WG. ".$message."\n");
                }
            } //new2ok
        }   else { // ($config['cron'] <> 1
